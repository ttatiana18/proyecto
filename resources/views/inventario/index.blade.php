                ...
                <table class="w-full whitespace-no-wrap">
                  <thead>
                    <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                      ...
                      <th class="px-4 py-3 text-center">Mensaje</th>
                  ...
                  <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    @forelse($productos as $producto)
                        ...
                        <td class="px-2 py-3 text-center">
                            <p class="font-semibold">{{$producto->nombreProducto}}</p>
                        </td>
                        ...
                        <td class="px-4 py-3 text-sm text-center">
                            @if($producto->cantidad <= 0)
                                <span class="px-2 py-1 font-semibold leading-tight text-red-700 bg-red-100 rounded-full dark:text-red-100 dark:bg-red-700">PRODUCTO AGOTADO</span>
                            @elseif($producto->cantidad > 0 && $producto->cantidad <= 10)
                                <span class="px-2 py-1 font-semibold leading-tight text-orange-700 bg-orange-100 rounded-full dark:text-white dark:bg-orange-600">PRODUCTO PROXIMO A AGOTARSE</span>
                            @else
                                <span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100">PRODUCTO CON EXISTENCIAS SUFICIENTES</span>
                            @endif
                        </td>
                        <td class="flex px-2 py-3 text-sm text-center">
                            <a href="{{route('productos.show',$producto->idProducto)}}" class="ml-2 px-4 py-1 font-semibold leading-tight text-orange-700 bg-orange-100 rounded-full dark:bg-orange-500 dark:text-orange-100">Ver</a>
